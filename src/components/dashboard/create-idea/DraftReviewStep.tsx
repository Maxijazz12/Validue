  ...
  const generationBanner = generationInfo
    ? generationInfo.source === "ai"
      ? {
          ...
          copy: "This draft was generated by AI and refined through a quality pass.",
        }
      : {
        ...
        <div className="flex flex-col gap-[16px] md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="text-[14px] text-text-secondary mt-[4px]">
              Tweak the details, then publish when it feels right
            </p>
          </div>
          {onRegenerate && (
            <button
      ...
      <div className="grid grid-cols-[1fr_280px] gap-[24px] max-lg:grid-cols-1">
        ...
        <div className="flex flex-col gap-[24px]">
          ...
          <div className="bg-white border border-border-light shadow-card rounded-[20px] md:rounded-[28px] px-[14px] py-[20px] md:p-[28px]">
            ...
            <p className="text-[13px] text-text-muted mb-[24px]">
              What respondents see on The Wall.
            </p>
            ...
            <div className="flex flex-col gap-[20px]">
              ...
              <div className="flex flex-col gap-[6px]">
                ...
                <input
                  ...
                  className="w-full px-[16px] py-[12px] rounded-xl border border-border-light bg-white text-[15px] text-text-primary font-sans placeholder:text-text-muted outline-none transition-all duration-200 focus:border-border-muted focus:shadow-[0_0_0_3px_rgba(0,0,0,0.04)]"
                />
              </div>
              ...
              <div className="flex flex-col gap-[6px]">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-[16px] py-[12px] rounded-xl border border-border-light bg-white text-[15px] text-text-primary font-sans placeholder:text-text-muted outline-none transition-all duration-200 focus:border-border-muted focus:shadow-[0_0_0_3px_rgba(0,0,0,0.04)] resize-y min-h-[100px]"
                />
              </div>
                    ...
                    {draft.tags.map((tag) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="text-text-muted hover:text-text-secondary transition-colors cursor-pointer border-none bg-transparent p-0 text-[14px] leading-none"
                        >
                          &times;
                        </button>
                      </span>
              ...
              <div className="flex flex-col gap-[8px]">
                ...
                {draft.assumptions.map((a, i) => (
                  <div key={`assumption-${i}-${a}`} className="flex items-center gap-[8px]">
                    <span className="text-[12px] text-text-muted w-[16px] shrink-0">
                      {i + 1}.
                    </span>
                    <input
                      ref={(node) => {
                    ...
                    <button
                      ...
                      className={`w-[28px] h-[28px] rounded-md flex items-center justify-center transition-all cursor-pointer border-none bg-transparent ${
                        improvingAssumption === i
                          ...
                          : "text-text-muted hover:bg-[#f3e8ff] hover:text-[#a855f7]"
                      }`}
                      title="AI improve"
                    >
                    ...
                    <button
                      ...
                      className="text-text-muted hover:text-red-500 transition-colors cursor-pointer border-none bg-transparent p-[4px]"
                    >
                      <svg
                        width="14"
                        height="14"
          ...
          <div className="bg-white border border-border-light shadow-card rounded-[20px] md:rounded-[28px] px-[14px] py-[20px] md:p-[28px]">
            <h2 className="font-mono text-[12px] font-medium uppercase tracking-wide text-text-primary mb-[8px]">Campaign Format</h2>
          ...
          <div className="bg-white border border-border-light shadow-card rounded-[20px] md:rounded-[28px] px-[14px] py-[20px] md:p-[28px]">
            ...
            <p className="text-[13px] text-text-muted mb-[28px]">
              Fund your campaign to reach more people faster.
            </p>
                ...
                {showCustomAmount && (
                  <div className="mt-[8px]">
                    <div className="relative">
                      <span className="absolute left-[16px] top-1/2 -translate-y-1/2 text-[15px] text-text-muted">
                        $
                      </span>
                      <input
                        id="reward-amount"
        ...
        <div className="max-lg:order-first">
          <div className="sticky top-[24px] flex flex-col gap-[16px]">
            ...
            <div>
              <p className="text-[10px] font-semibold tracking-[1.5px] uppercase text-text-muted mb-[8px]">
                Wall Preview
              </p>

...
export default function WallError({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-[80px] px-[24px]">
      <div className="w-[56px] h-[56px] rounded-2xl bg-[#ef4444]/10 flex items-center justify-center mb-[20px]">
      ...
      <p className="text-[14px] text-[#64748B] max-w-[360px] text-center mb-[24px]">
        We had trouble loading campaigns. This is usually temporary.
      </p>
      {error.message && process.env.NODE_ENV === "development" && (
        <pre className="text-[12px] text-[#ef4444] bg-[#ef4444]/5 rounded-xl p-[12px] mb-[16px] max-w-[480px] overflow-auto whitespace-pre-wrap">
          {error.message}
        </pre>
      )}

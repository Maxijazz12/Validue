...
export default function LoginPageClient({
  ...
  const signupHref = buildAuthPageHref("/auth/signup", rawNext);
      ...
      <div className="w-full max-w-[400px] relative z-10">
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-2xl p-[40px] shadow-card-sm relative overflow-hidden">
          ...
          <p className="text-[14px] text-[#94A3B8] mb-[32px]">
            Sign in to continue to Validue
          </p>
            ...
            <div>
              ...
              <div className="text-right mt-[6px]">
                <Link
                  ...
                  className="text-[12px] text-[#64748B] hover:text-[#111111] no-underline transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <p className="text-center text-[13px] text-[#94A3B8] mt-[24px]">
            ...
            <Link href={signupHref} className="text-[#111111] font-medium no-underline hover:underline">
              Sign up
            </Link>
          </p>
        </div>

...
export const tickerFacts = [
  ...
  "Average idea fills in under 3 hours",
  "2,400+ ideas posted across 40+ countries",
  "Top respondents earn $200+/month",
  "Founders from YC, Techstars, and indie",
  "New ideas posted every hour",
  "Quality-scored feedback, not surveys",
  "18 min average time to first response",
  "Real target users, not random panels",
  "Browse. Respond. Get paid.",
];
...
export const mockResponses = [
  {
    ...
    text: '"I tried three meal kits last year. I canceled all of them — not because of the food, but because planning around delivery days felt like a chore..."',
    stars: 5,
    amount: "+$5.00",
    isTop: true,
    color: "#3b82f6",
  },
  {
    ...
    text: '"We loved the variety but the portions were too small for a family. Ended up supplementing with groceries anyway..."',
    stars: 4,
    amount: "+$2.50",
    isTop: false,
    color: "#a855f7",
...
export const pricingTiers = [
  {
    ...
    features: [
      "1 campaign/month",
      "100 baseline reach per campaign",
      "Basic audience matching",
      "3 AI-generated questions",
      "3 campaigns your first month",
    ],
    cta: "Get Started",
    featured: false,
  },
  {
    ...
    features: [
      "3 campaigns/month",
      "250 baseline reach each",
      "20 reach units per $1 funded",
  ...
  },
  {
    ...
    features: [
      "8 campaigns/month",
      "600 baseline reach each",
      "24 reach units per $1 funded",
      "8 AI-generated questions",
      "AI-powered insight summary",
    ],
    cta: "Launch Idea",
    featured: true,
  },
  {
    ...
    features: [
      "20 campaigns/month",
      "1,500 baseline reach each",
      "28 reach units per $1 funded",
...
export const floatingNotifications = [
  { text: "Alex just earned +$12.00", color: "#3b82f6" },
  { text: "New idea posted: AI Study Buddy", color: "#22c55e" },
  { text: "Marcus T. earned +$5.00", color: "#a855f7" },
  { text: "42 responses in 2 hours", color: "#e8b87a" },
];
...
export const startupQuotes = [
  ...
  {
    text: "WhatsApp had 55 employees when Facebook acquired it for $19 billion.",
    source: "WhatsApp, 2014",
  },
  {
  ...
  {
    text: "Steve Jobs was fired from Apple — the company he co-founded — before returning to make it the most valuable company on Earth.",
    source: "Apple, 1985–1997",
  },
  {
  ...
  {
    text: "The first ever tweet was 'just setting up my twttr' — Twitter is now worth billions.",
    source: "Jack Dorsey, 2006",
  },
  {
  ...
  {
    text: "Atlassian went public with zero salespeople. Their product sold itself entirely through word of mouth.",
    source: "Atlassian",
  },
  {
  ...
  {
    text: "Pieter Levels built Nomad List as a solo founder with just a spreadsheet. It now earns over $2M/year.",
    source: "Nomad List",
  },
  {
    text: "The entire first version of Craigslist was just an email list that Craig Newmark maintained by hand.",
    source: "Craigslist, 1995",
  },
];
